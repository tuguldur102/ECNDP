      ...
      for budget_k in tqdm(k_values, desc="Deletion set loop"):
        ...
        for repetition in tqdm(range(MAX_REPETITION), desc="max_repetition"):
          try:
            ...
            print(f"\nExact path: terminals: {len(terminals_assigned)} and {budget_k}")
            ...
            print(f"\nExact path - obj: {objective_value} and total time: {total_time}\n")
